...
public class testpage {
    ...
    @FindBy(className = "jp-results-headline")
  //  @FindBy(css ="span[class='hero-headline']")
    ...
    @FindBy(xpath = "//*[@id='plan-a-journey']/div[1]/div[1]/div[1]/span[2]/strong")
    ...
    @FindBy (xpath = "//*[@id=\'plan-a-journey\']/div[1]/div[1]/div[2]/span[2]/strong")
    ...
    @FindBy(xpath = "//*[@id=\'plan-a-journey\']/div[1]/div[3]/a[1]/span")
...
//    @FindBy(className ="label.boxed-label-for-input")
    @FindBy(xpath = "//*[@id='more-journey-options']/div/fieldset/ul[2]/li[2]/fieldset/div/div/div[1]/label[4]")
